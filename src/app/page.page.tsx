  ...
  return (
    <main>
      ...
      <div className='layout'>
        <div className='mt-[60px] flex gap-[20px]'>
          <div className='relative flex justify-center flex-col gap-[20px]'>
            <h1 className='text-5xl font-semibold border-b-2 pb-[20px] leading-[1.5]'>
              SOLUSI PENCARIAN{' '}
      ...
      <Image
        ...
        height={60}
        width={1200}
        className='layout object-contain'
      />
      <div className='pt-[60px]' id='faq'></div>
      <div className='layout pb-[60px]'>
